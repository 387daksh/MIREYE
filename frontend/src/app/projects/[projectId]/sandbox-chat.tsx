...
const ACTIVITY: Record<string, string> = {
  ...
  propose_bess_facility: "Created a conceptual BESS facility",
...
const PROMPTS = [
  "Design a 100 MW / 400 MWh / 4-hour phase-1 BESS with room for 300 MW / 1,200 MWh later.",
  "Create a second layout with more expansion room.",
  "Which layout uses the least land?",
  "Why is export/injection interconnection unresolved?",
